...
class LoginScreen(Screen):
    def __init__(self, **kwargs):
        ...
        login_label_pos_x = Window.width / 2 - login_label.width / 2
        login_label_pos_y = Window.height / 2 + 100
        ...
        login_input_pos_x = Window.width / 2 - login_input.width / 2
        login_input_pos_y = Window.height / 2 + 50
        ...
        password_label_pos_x = Window.width / 2 - password_label.width / 2
        password_label_pos_y = Window.height / 2
        ...
        password_input_pos_x = Window.width / 2 - password_input.width / 2
        password_input_pos_y = Window.height / 2 - 50
        ...
        button_pos_x = Window.width / 2 - button.width / 2
        button_pos_y = Window.height / 2 - 120
...
class NextScreen(Screen):
    def __init__(self, **kwargs):
        ...
        fio_label = Label(text='Осколков Максим Владимирович', size_hint=(None, None), size=(300, 50))
        fio_label_pos_x = Window.width / 2 - fio_label.width / 2
        fio_label_pos_y = Window.height / 2 + 500
        ...
        button1_pos_x = Window.width / 2 - 250
        button1_pos_y = Window.height / 2 + 400
        ...
        button2_pos_x = Window.width / 2
        button2_pos_y = Window.height / 2 + 400
        ...
        hours_label_pos_x = Window.width / 2 - hours_label.width / 2
        hours_label_pos_y = Window.height / 2 + 300
        ...
        days_label_pos_x = Window.width / 2 - days_label.width / 2
        days_label_pos_y = Window.height / 2 + 250
        ...
        button3_pos_x = Window.width / 2 + 270
        button3_pos_y = Window.height / 2 + 500
...
class TestApp(App):
    ...
    def build(self):
        ...
        sm.add_widget(NextScreen(name='QRScreen'))
